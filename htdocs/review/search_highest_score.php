...
$allowed_sort = array ('review_item_category','item_name','category','address','zip');
...
$_SESSION['limit'] = "$limit";
    $result = mysql_query("select count(*) from review WHERE $criteria= '$searchterm'");  
...
COUNT(review.id) AS total, (SUM(review.rating)/COUNT(review.id)) AS orate FROM review, review_items WHERE review_items.item_id=review.review_item_id GROUP BY review_items.item_id ORDER BY orate $order limit $offset, $limit";
	} //if
	else {
...
$query = "select * from review WHERE $criteria= '$searchterm'
";
if (isset($rating)){
...
?>
    ...
    <td valign="top" nowrap class="body"><span class="body"><?php echo "$neighborhood"; ?></span></td>
    <td valign="top" nowrap><span class="body"><?php echo "$address"; ?></span></td>
    <td valign="top" nowrap class="body"><span class="body"><?php echo "$zip"; ?></span></td>
  </tr>
  <?php } ?>
</table>
<div align="center"> 
