...
$fav_id = $_GET["fav_id"];
	...
	$sql = "DELETE FROM review_favorites WHERE fav_id = \"$fav_id\" LIMIT 1";
	...
	if (!$sql_result) {  
		...
		BodyHeader("$sitename:  Delete A Favorite"); 
        ?>
...
<div align="center">
  <p>&nbsp;</p>
  <p><br />
        <span class="box1">You have successfully deleted an item from your favorites list. </span>
    </p>
</div>
<P>
<P> 
