...
<table width="252" height="66"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#000000">
  <tr>
    <td width="212" height="64" align="center" valign="top" bgcolor="#FFFFFF"><div align="center">
	...
	if($flag==1){
      ...
      <?php
		...
		if ($average >= "1.0") { ?>
      <span class="index2-small-bold"><span class="style5">
        </span>
        <?php } //if average
		$average_for = sprintf ("%01.1f", $average);
		if ($average <= "5.0") { echo "(Average Review ".$average_for." Stars)";  } ?>
        </span>
      <?php
...
?>
      ...
      <?php
	  	  if (($total >= "1")) {
		  echo "<span class=index2-small-bold><span class=style5>Number of<a href=".$directory."/index2.php?item_id=".$item_id."&amp;back=".$_SERVER['REQUEST_URI']."&amp;".htmlspecialchars(SID).">Reviews</a>:</span>".$total."</span><br/><table width=100% border=0 cellspacing=0 cellpadding=0><tr><td width=50% height=19><a href=".$directory."/review_form.php?item_id=".$item_id."&amp;$back=".$_SERVER['REQUEST_URI']."&amp;".htmlspecialchars(SID)."><img src=".$directory."/images/buttonWriteAReview.gif title=Submit a ".$item_name2." review width=87 height=13 border=0 /></a></td><td width=50%><a href=".$directory."/index2.php?item_id=".$item_id."&amp;back=".$_SERVER['REQUEST_URI']."&amp;".htmlspecialchars(SID)."><img src=".$directory."/images/buttonReadAllReviews.gif width=99 height=13 title=Submit a ".$item_name2." review border=0 /></td></tr></table>";
		 } else {
			echo "<a href=".$directory."/review_form.php?item_id=".$item_id."&amp;$back=".$_SERVER['REQUEST_URI']."&amp;".htmlspecialchars(SID)."><img src=".$directory."/images/be_1st_to_review.jpg title=Submit a".$item_name2."review border=0/></a>";	
}?>	
    </div></td>
</tr>
</table>
