<?php
	...
	$sql = "SELECT category FROM review_category_list where category = '$category' and parent_id = " . $_POST['parent'];
	...
	$sql = "INSERT INTO review_category_list SET category = '$category', parent_id = " . $_POST['parent'];
	$result = @mysql_query($sql,$connection) or die(sprintf("Couldn't execute sql, %s: %s", db_errno(), db_error()));	
