...
<p align="center" class="style1">Welcome to Five Star Review Script Upgrade 5.1 to 5.2</p>
<hr>
...
<form name="form1" method="post" action="upgrade5to51.php?step=2">
  <div align="right">
...
run_query_batch($connection, "upgrade_to_5.2.sql");
