ALTER TABLE `users` RENAME `review_users` ;

ALTER TABLE `review_users` ADD `email` VARCHAR( 200 ) NOT NULL ,
ADD `regkey` VARCHAR( 25 ) NOT NULL ,
ADD `sig` varchar(250) NOT NULL default '',
ADD `sig_url` varchar(250) NOT NULL default '',
ADD `aboutme` text NOT NULL,
ADD `city` varchar(250) NOT NULL default '',
ADD `state` char(5) NOT NULL default '',
ADD `zip` varchar(5) NOT NULL default '',
ADD `profession` varchar(250) NOT NULL default '',
ADD `age` char(3) NOT NULL default '',
