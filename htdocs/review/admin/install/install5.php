...
<p class="style2">If you prefer not to mess with all of this you can have this script professionally installed for you. The fee is $35. After clicking the Buy Now button, you will need to send an email to <a href="mailto:webmaster@review-script.com">webmaster@review-script.com</a> with the following information: </p>
...
<form name="form1" method="post" action="install5.php?step=2">
  <div align="right">
...
<form name="form2" method="post" action="install5.php?step=3">
...
?>
<form name="form1" method="post" action="install5.php?step=4">
  <div align="right">
...
<form name="form2" method="post" action="install5.php?step=5">
<table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">

  <tr>
    <td class="style2">License </td>
    <td><input name="license" type="text" id="license" value=""></td>
  </tr>
  ...
  <tr>
    ...
    <td><input name="NumPages" type="text" id="NumPages" value="5"  /></td>
  </tr>
  <tr>
...
$file_contents = <<<EOD
<?php
\$license = '$_POST[license]'; //valid license for product.
...
echo "$msg"; 
  ...
  ?> </p>
	<span class="style4">REMOVE THE INSTALL DIRECTORY FROM YOUR SERVER FOR SECURITY PURPOSES.    </span>
