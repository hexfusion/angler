...
BodyHeader("Five Star Review Script Upgrade 5.5 to 5.6","","");
...
<form name="form1" method="post" action="upgrade5.5to5.6.php?step=2">
  <div align="right">
...
run_query_batch($connection, "upgrade_to_5.6.sql");
