...
$aboutme= stripslashes($_POST['aboutme']);
$sig= stripslashes($_POST['sig']);
$passtext= stripslashes($_POST['passtext']);
$skype= stripslashes($_POST['skype']);
$email= stripslashes($_POST['email']);
$adsense_clientid= stripslashes($_POST['adsense_clientid']);
$adsense_channelid= stripslashes($_POST['adsense_channelid']);
