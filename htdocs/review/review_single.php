...
where
review.review_item_id = '$item_id' AND review.id = '$id' AND approve = 'y'
AND $build
ORDER BY $sort $order
";
...
BodyHeader("Reviews - $sitename","Review for $item_name","$item_name");
	?>
...
<br />
<span class="small"><a href="recommend.php?item_id=<?php echo "$item_id"; ?>&<?php echo htmlspecialchars(SID); ?>">Email</a> a friend about this <?php echo "$item_type2"; ?>.</span></font><br />
...
<tr> 
  <td><font face=verdana,arial,helvetica size=-1>reviewer: <b> <a href="reviewer_about.php?username=<?php echo "$username"; ?>&<?php echo htmlspecialchars(SID); ?>"><?php echo ucfirst($source); ?></a></b> 
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <th width="33%" scope="col"><a href="javascript: history.go(-1)">Back</a> to Previous Page &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>


<th width="34%" scope="col">Show other <a href="index2.php?item_id=<?php echo "$item_id"; ?>&<?php echo htmlspecialchars(SID); ?>">reviews</a> for this item</th>
  </tr>
</table>
<!-- stopprint -->
<?php } //end pagination check 
