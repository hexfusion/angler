...
&lt;script type="text/javascript" src="<?php echo $webpath; ?>livehelp_js.php?<?php echo $relativehtml; ?><?php echo $departmenthtml; ?><?php echo $whathtml; ?><?php echo $whathost; ?><?php echo $whatserversession; ?><?php echo $whatpingtimes; ?><?php echo $frameparent; ?><?php echo $secure ?><?php echo $filter ?><?php echo $usernamehtml; ?>"&gt;&lt;/script&gt;
...
<a href=http://www.craftysyntax.com/ target=_blank>Crafty Syntax Live Help</a> &copy; 2003 - 2007 by <a href=http://www.craftysyntax.com/EricGerdes/ target=_blank>Eric Gerdes</a>  
<br>
