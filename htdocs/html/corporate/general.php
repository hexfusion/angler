...
include "header.php";
/********************************************************** PHP */?>
<div class="title"><?= $script_name ?> General Settings</div><br /><?= $msg ?>
...
<br />
<table bgcolor="#FF8A00" border="0" cellspacing="0" cellpadding="0"><tr><td align="left"><img src="leftuptransparent.gif" align="top" />&nbsp;</td><td><div class="containertitle">General Settings</div></td><td align="right">&nbsp;<img src="rightuptransparent.gif" align="top" /></td></tr></table>
...
<tr><td bgcolor="#EEEEEE">
  <table align="center" border="0" cellspacing="2" cellpadding="0">
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="helpdeskurl" size="30" value="<?= field( $_POST[helpdeskurl] ) ?>" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">URL To Your Site:&nbsp;</div></td>
      <td><input type="text" name="url" size="30" value="<?= field( $_POST[url] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="title" size="30" value="<?= field( $_POST[title] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr><td colspan="2" align="center">
    <table width="500" border="0" cellspacing="0" cellpadding="10" bgcolor="#FFFFFF"><tr><td>
    ...
    <tr valign="top">
      <td></td><td><div class="topinfo"><input type="checkbox" name="uploads" <? if( $_POST[uploads] ) echo "checked"  ?> />Allow file attachments<br /><img src="blank.gif" width="1" height="12" /></div></td>
    </tr>
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="email" size="30" value="<?= field( $_POST[email] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      ...
      <td><div class="topinfo"><input type="text" name="autoclose" size="5" value="<?= field( $_POST[autoclose] ) ?>" /> days</div></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Delete Tickets Closed For:&nbsp;</div></td>
      <td><div class="topinfo"><input type="text" name="autodelete" size="5" value="<?= field( $_POST[autodelete] ) ?>" /> days</div><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      ...
      <td><textarea name="banned_ips" rows="5" cols="40"><?= field( $_POST[banned_ips] ) ?></textarea></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Banned Emails:&nbsp;</div></td>
      <td><textarea name="banned_emails" rows="5" cols="40"><?= field( $_POST[banned_emails] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td></td><td><div class="topinfo"><input type="checkbox" name="floodcontrol" <? if( $_POST[floodcontrol] ) echo "checked"  ?> />Enable flood control<br /><img src="blank.gif" width="1" height="12" /></div></td>
    </tr>
