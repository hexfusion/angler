...
SugarWidgetSchedulerSearch.submit = function(form) {
	...
	if(form.search_first_name.value != '') {
		conditions[conditions.length] = {"name":"first_name","op":"starts_with","value":JSON.stringify(form.search_first_name.value)}
	}
	if(form.search_last_name.value != '') {
		conditions[conditions.length] = {"name":"last_name","op":"starts_with","value":JSON.stringify(form.search_last_name.value)}
	}
	if(form.search_email.value != '') {
		conditions[conditions.length] = {"name":"email1","op":"starts_with","value":JSON.stringify(form.search_email.value)}
	}
