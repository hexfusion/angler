...
<div class="normal"><a href="<?= $HD_URL_REPLIES ?>">&gt;&gt; Back To Auto-Replies Main Page</a></div><br />
<table bgcolor="#FF8A00" border="0" cellspacing="0" cellpadding="0"><tr><td align="left"><img src="leftuptransparent.gif" align="top" />&nbsp;</td><td><div class="containertitle">Auto-Reply Options</div></td><td align="right">&nbsp;<img src="rightuptransparent.gif" align="top" /></td></tr></table>
...
/********************************************************** PHP */?>
    ...
    <tr valign="top">
      ...
      <td><textarea name="reply" rows="5" cols="40"><?= field( $_POST[reply] ) ?></textarea></td>
    </tr>
    <tr><td colspan="2" align="center"><img src="blank.gif" width="1" height="12" /><br />
    <table width="500" border="0" cellspacing="0" cellpadding="10" bgcolor="#FFFFFF"><tr><td>
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="phrase" size="30" value="<?= field( $_POST[phrase] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
<?/* PHP **********************************************************/
if( $global_priv || $priv )
{
