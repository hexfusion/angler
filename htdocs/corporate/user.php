  ...
  if( $global_priv )
  {
    if( trim( $_POST[email] ) != "" && trim( $_POST[name] ) != "" )
    {
      if( !get_row_count( "SELECT COUNT(*) FROM {$pre}user WHERE ( email = '{$_POST[email]}' )" ) )
      {
        ...
        mysql_query( "INSERT INTO {$pre}user ( name, email, password, date ) VALUES ( '{$_POST[name]}', '{$_POST[email]}', '$pass', '" . time( ) . "' )" );
...
include "header.php";
/********************************************************** PHP */?>
<div class="title"><?= $script_name ?> User Management</div><br /><?= $msg ?>
<?/* PHP **********************************************************/
if( $global_priv )
{
/********************************************************** PHP */?>
<table bgcolor="#FF8A00" border="0" cellspacing="0" cellpadding="0"><tr><td align="left"><img src="leftuptransparent.gif" align="top" />&nbsp;</td><td><div class="containertitle">Create New User</div></td><td align="right">&nbsp;<img src="rightuptransparent.gif" align="top" /></td></tr></table>
...
if( $_GET[cmd] != "view" )
{
  ...
  if( mysql_num_rows( $res ) )
  {
    ...
    echo "<tr bgcolor=\"#9CC2A3\"><td width=\"50\">&nbsp;</td><td><div class=\"tableheader\">Name</div></td><td><div class=\"tableheader\">Email</div></td></tr>\n";

    while( $row = mysql_fetch_array( $res ) )
    {
      $bgcolor = ($bgcolor == "#CCCCCC") ? "#EEEEEE" : "#CCCCCC";
...
else if( $_GET[cmd] == "view" )
{
  ...
  echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\" bgcolor=\"#9CC2A3\"><tr><td><div class=\"tableheader\">Viewing user info for " . field( $row[name] ) . "</div></td></tr><tr><td bgcolor=\"#FFFFFF\">";
  ...
  if( $global_priv )
  {
    ...
    echo "<tr bgcolor=\"#FDD6AA\"><td><div class=\"tableheader\">Ticket#</div></td><td><div class=\"tableheader\">Subject</div></td><td><div class=\"tableheader\">Ticket Date</div></td></tr>";
