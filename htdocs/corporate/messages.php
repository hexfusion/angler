...
include "header.php";
/********************************************************** PHP */?>
<div class="title"><?= $script_name ?> Message Center</div><br /><?= $msg ?>
...
<tr><td width="200" align="right"><div class="normal">Subject:<font color="#FF0000">*</font></div></td><td><input type="text" name="subject" value="<?= field( $_POST[subject] ) ?>" size="30" /></td></tr>
