...
include "header.php";
/********************************************************** PHP */?>
<div class="title"><?= $script_name ?> Statistics</div><br /><?= $msg ?>
<div class="normal">
<?/* PHP **********************************************************/
echo "<ul>";
...
while( $row = mysql_fetch_array( $res ) )
{
  ...
  if( $row[2] == $HD_STATUS_OPEN )
  {
    $res_temp = mysql_query( "SELECT user_id FROM {$pre}post WHERE ( ticket_id = '{$row[0]}' ) ORDER BY date DESC LIMIT 1" );
