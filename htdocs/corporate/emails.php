...
include "header.php";
/********************************************************** PHP */?>
<div class="title"><?= $script_name ?> Customize Emails</div><br /><?= $msg ?>
...
<br />
<table bgcolor="#FF8A00" border="0" cellspacing="0" cellpadding="0"><tr><td align="left"><img src="leftuptransparent.gif" align="top" />&nbsp;</td><td><div class="containertitle">Emails</div></td><td align="right">&nbsp;<img src="rightuptransparent.gif" align="top" /></td></tr></table>
...
<tr><td bgcolor="#EEEEEE">
  <table align="center" border="0" cellspacing="2" cellpadding="0">
    ...
    <tr valign="top">
      ...
      <td><textarea name="emailheader" rows="5" cols="40"><?= field( $_POST[emailheader] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Footer:&nbsp;</div></td>
      <td><textarea name="emailfooter" rows="5" cols="40"><?= field( $_POST[emailfooter] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      ...
      <td><textarea name="email_ticket_created" rows="5" cols="40"><?= field( $_POST[email_ticket_created] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_ticket_created_subject" size="30" value="<?= field( $_POST[email_ticket_created_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td align="right"><div class="topinfo">Message:&nbsp;</div></td>
      <td><textarea name="email_ticket_notify" rows="5" cols="40"><?= field( $_POST[email_ticket_notify] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_ticket_notify_subject" size="30" value="<?= field( $_POST[email_ticket_notify_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td align="right"><div class="topinfo">Message:&nbsp;</div></td>
      <td><textarea name="email_notify_create" rows="5" cols="40"><?= field( $_POST[email_notify_create] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_notify_create_subject" size="30" value="<?= field( $_POST[email_notify_create_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td align="right"><div class="topinfo">Message:&nbsp;</div></td>
      <td><textarea name="email_notify_reply" rows="5" cols="40"><?= field( $_POST[email_notify_reply] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_notify_reply_subject" size="30" value="<?= field( $_POST[email_notify_reply_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td align="right"><div class="topinfo">Message:&nbsp;</div></td>
      <td><textarea name="email_notifysms_create" rows="5" cols="40"><?= field( $_POST[email_notifysms_create] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_notifysms_create_subject" size="30" value="<?= field( $_POST[email_notifysms_create_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td align="right"><div class="topinfo">Message:&nbsp;</div></td>
      <td><textarea name="email_notifysms_reply" rows="5" cols="40"><?= field( $_POST[email_notifysms_reply] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_notifysms_reply_subject" size="30" value="<?= field( $_POST[email_notifysms_reply_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    ...
    <tr valign="top">
      <td align="right"><div class="topinfo">Message:&nbsp;</div></td>
      <td><textarea name="email_ticket_survey" rows="5" cols="40"><?= field( $_POST[email_ticket_survey] ) ?></textarea><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
    <tr valign="top">
      <td align="right"><div class="topinfo">Subject:&nbsp;</div></td>
      <td><input type="text" name="email_ticket_survey_subject" size="30" value="<?= field( $_POST[email_ticket_survey_subject] ) ?>" /><br /><img src="blank.gif" width="1" height="12" /></td>
    </tr>
