<?php /* Smarty version 2.6.10, created on 2006-03-08 17:02:04
         compiled from gallery:modules/core/templates/ItemEditTheme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'gallery:modules/core/templates/ItemEditTheme.tpl', 25, false),array('function', 'html_options', 'gallery:modules/core/templates/ItemEditTheme.tpl', 36, false),array('modifier', 'default', 'gallery:modules/core/templates/ItemEditTheme.tpl', 30, false),)), $this); ?>
<div class="gbBlock">
...
"
		  onchange="changeSetting('<?php echo $this->_tpl_vars['settingKey']; ?>
')">
	    <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['setting']['choices'],'selected' => $this->_tpl_vars['setting']['value']), $this);?>

	  </select>
	<?php elseif (( $this->_tpl_vars['setting']['type'] == 'checkbox' )): ?>
	  <input type="checkbox" onchange="changeSetting('<?php echo $this->_tpl_vars['settingKey']; ?>
')"
		 name="<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[key][".($this->_tpl_vars['settingKey'])."]"), $this);?>
"
	   <?php if (! empty ( $this->_tpl_vars['setting']['value'] )): ?>checked="checked"<?php endif; ?>/>
...
"
	 <?php if (( ! isset ( $this->_tpl_vars['ItemEditTheme']['globalParams'][$this->_tpl_vars['settingKey']] ) )): ?>
	   disabled="disabled"
	 <?php elseif (( $this->_tpl_vars['setting']['value'] == $this->_tpl_vars['ItemEditTheme']['globalParams'][$this->_tpl_vars['settingKey']] )): ?>
	   checked="checked"
	 <?php endif; ?>/>
      </td>
    </tr>
