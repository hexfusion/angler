 ...
 */
$gallery->setConfig('setup.password', 'pass');
 ...
 */
$gallery->setConfig('data.gallery.base', '/home/virtual/site12/fst/var/www/html/gallery/g2data');
...
$storeConfig['database'] = 'westbranchresort_com_-_hd';
$storeConfig['username'] = 'root';
$storeConfig['password'] = 's1a2mayfly';
