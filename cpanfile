...
requires 'Dancer::Plugin::Interchange6', '0.080';
requires 'Dancer::Session::DBIC', '0.004';
# requires 'Dancer::Template::TemplateFlute', '0.0113';
requires 'Interchange6::Schema', '0.081';
requires 'Interchange6', '0.080';
...
requires 'Data::Transpose', '0.0012';
